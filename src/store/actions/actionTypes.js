const actionTypes = Object.freeze({
    ...
    CREATE_USER_FAILED: 'CREATE_USER_FAILD',

    FETCH_ALL_USER_SUCCESS: 'FETCH_ALL_USER_SUCCESS',
    FETCH_ALL_USER_FAIL: 'FETCH_ALL_USER_FAIL',

    DELETE_USER_SUCCESS: 'DELETE_USER_SUCCESS',
    DELETE_USER_FAILED: 'DELETE_USER_FAILD',

    EDIT_USER_SUCCESS: 'EDIT_USER_SUCCESS',
    EDIT_USER_FAILED: 'EDIT_USER_FAILD',
    // get data to homepage
    ...
    FETCH_SAVE_DETAIL_DOCTOR_FAIL: 'FETCH_SAVE_DETAIL_DOCTOR_FAIL',

    FETCH_ALLCODE_SCHEDULE_DOCTOR_SUCCESS: 'FETCH_ALLCODE_SCHEDULE_DOCTOR_SUCCESS',
    FETCH_ALLCODE_SCHEDULE_DOCTOR_FAIL: 'FETCH_ALLCODE_SCHEDULE_DOCTOR_FAIL',
