                ...
                <div className="home-header-container">
                    <div className="home-header-content">
                        ...
                        <div className="center-content">
                            ...
                            <div className="child-content">
                                <div><b><FormattedMessage id="homeheader.healtfacility" /></b></div>
                            ...
                            <div className="child-content">
                                ...
                                <div className="sub-title"><FormattedMessage id="homeheader.checkhealt" /></div>
                            </div>
                        </div>
                        ...
                        <div className="content-down">
                            <div className="options">
                                <div className="option-child">
                                    ...
                                    <div className="text-child"><FormattedMessage id="banner.SpecializedExamination" /></div>
                                </div>
                                <div className="option-child">
